...
predict_path = "/home/dung/KITTI/ALP/yolov7_fake/yolov7/predict"
# label_2 folder 
            ...
            for i in range(gt_df.shape[0]):
                ...
                if class_name == 'Person':
                    ...
                    if IoU and save:
                        ...
                        path_txt_gt = f'/home/dung/KITTI/ALP/yolov7_fake/yolov7/predict_with_position/{predict}'
                        print(f'{name_file}')
                        ...
                        f.write("{} {} {} {} {} {} {} {} {} {}\n".format(class_name, x_min, y_min, x_max, y_max, x_gt, y_gt, z_gt, distance2cam,name_file))
                print('----------next_gt--------')
print(iou_count)
print(max_iou)
print(len(max_iou))
